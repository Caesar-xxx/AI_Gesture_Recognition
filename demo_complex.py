...
class HandControlVolume:
    ...
    def recognize(self):
        ...
        # 创建多个方块
        for i in range(0, 5):
            squareManager.create(120 * i + 20, 200, 0.6)
        ...
        with self.mp_hands.Hands(min_detection_confidence=0.7,
            ...
            while cap.isOpened():
                ...
                # 显示距离
                cv2.putText(self.image, "Distance:" + str(rect_percent_text), (5, 100), cv2.FONT_HERSHEY_PLAIN, 1,
                            (255, 255, 0), 1)

                # 显示当前激活
                cv2.putText(self.image, "Active:" + (
                    "None" if squareManager.active_index == -1 else str(squareManager.active_index)), (5, 150),
                ...
                fpsTime = cTime
                cv2.putText(self.image, "FPS: " + str(int(fps_text)), (5, 50),
                            cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 0), 1)
                # 显示画面
